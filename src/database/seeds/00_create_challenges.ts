...
export async function seed(knex: Knex) {
    await knex('challenges').insert([
        { option: 'verdade', description: 'Você já ficou com uma pessoa do sexo oposto?' },
        { option: 'desafio', description: 'Beba um copo de cerveja sem usar as mãos' },
        { option: 'verdade', description: 'Tem crush por algum colega de trabalho' },
        { option: 'desafio', description: 'Levante e dance uma música aleatória' },
        { option: 'verdade', description: 'Já ficou com algum colega de trabalho' },
